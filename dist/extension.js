...
const chat_1 = __importDefault(__webpack_require__(2));
const constants_1 = __webpack_require__(12);
function activate(context) {
    const apikey = vscode.workspace.getConfiguration(constants_1.CONFIG_APP_NAME).get(constants_1.CONFIG_API_KEY_NAME);
    if (!apikey || apikey === "") {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const vscode = __importStar(__webpack_require__(1));
const handler_1 = __importDefault(__webpack_require__(3));
const AI_PARTICIPANT_ID = "ai-code.generator";
function default_1(context) {
    const aiCode = vscode.chat.createChatParticipant(AI_PARTICIPANT_ID, handler_1.default);
    aiCode.iconPath = vscode.Uri.joinPath(context.extensionUri, "src", "assets", "icons", "plugin-chat-black-cat.jpg");
}
...
const strategy_1 = __importDefault(__webpack_require__(4));
var PluginAction;
(function (PluginAction) {
    PluginAction["EXPLAIN_PLUGIN"] = "explain-plugin";
    PluginAction["GENERATE_CODE"] = "generate";
    PluginAction["HELP"] = "help";
})(PluginAction || (exports.PluginAction = PluginAction = {}));
const handler = async (request, context, stream, token) => {
    const strategyResponse = await (0, strategy_1.default)(request, context);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const help_action_1 = __importDefault(__webpack_require__(5));
async function default_1(request, extensionContext) {
    return await (0, help_action_1.default)(request, extensionContext);
}
exports["default"] = default_1;
...
const vscode = __importStar(__webpack_require__(1));
const generate_action_1 = __importDefault(__webpack_require__(6));
const ai_client_service_1 = __importDefault(__webpack_require__(13));
const prompt_service_1 = __importStar(__webpack_require__(8));
const useEnvVar_1 = __importDefault(__webpack_require__(120));
async function default_1(request, extensionContext) {
    if (request.command !== __1.PluginAction.HELP) {
        return (0, generate_action_1.default)(request, extensionContext);
    }
    const { apiKey, model } = (0, useEnvVar_1.default)();
    if (!apiKey || apiKey === "") {
        vscode.window.showInformationMessage("Please set your api key in the settings (ai-generate-code)!");
        return "Please set your api key in the settings! (ai-generate-code)";
    }
    const prompt = request.prompt;
    const sysPrompt = {
        content: await (0, prompt_service_1.default)({
            context: extensionContext,
            action: prompt_service_1.PromptAction.HELP,
        }),
        role: "system",
    };
    const messages = [sysPrompt];
    const aiClient = await (0, ai_client_service_1.default)({
        apiKey,
        settings: {
            model,
            messages,
...
const vscode = __importStar(__webpack_require__(1));
const __1 = __webpack_require__(3);
const explain_plugin_action_1 = __importDefault(__webpack_require__(7));
const prompt_service_1 = __importStar(__webpack_require__(8));
const ai_client_service_1 = __importDefault(__webpack_require__(13));
const useEnvVar_1 = __importDefault(__webpack_require__(120));
async function default_1(request, extensionContext) {
    if (request.command !== __1.PluginAction.GENERATE_CODE) {
        return (0, explain_plugin_action_1.default)(request);
    }
    const { apiKey, model } = (0, useEnvVar_1.default)();
    if (!apiKey || apiKey === "") {
        vscode.window.showInformationMessage("Please set your api key in the settings (ai-generate-code)!");
    ...
    const sysPrompt = {
        content: await (0, prompt_service_1.default)({
            context: extensionContext,
            action: prompt_service_1.PromptAction.GENERATE,
        }),
        role: "system",
    };
    const messages = [sysPrompt];
...
async function default_1(request) {
    return "To use this plugin, you can type the following commands:\n\n" +
        `1. /${__1.PluginAction.EXPLAIN_PLUGIN} - to get an explanation of the plugin\n` +
        `2. /${__1.PluginAction.GENERATE_CODE} - to generate code using the plugin\n` +
        `3. /${__1.PluginAction.HELP} - to get help with any bugs do you have\n`;
}
exports["default"] = default_1;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.PromptAction = void 0;
const actionStrategy_1 = __importDefault(__webpack_require__(9));
var PromptAction;
(function (PromptAction) {
    PromptAction["HELP"] = "help";
    PromptAction["GENERATE"] = "generate";
})(PromptAction || (exports.PromptAction = PromptAction = {}));
function default_1({ context, action }) {
    const promptToRun = (0, actionStrategy_1.default)(action, context);
    return promptToRun;
}
exports["default"] = default_1;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const getGeneratePrompt_1 = __importDefault(__webpack_require__(10));
function getPromptToRun(action, context) {
    return (0, getGeneratePrompt_1.default)(action, context);
}
exports["default"] = getPromptToRun;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const prompt_service_1 = __webpack_require__(8);
const getHelpPrompt_1 = __importDefault(__webpack_require__(11));
const generate_1 = __importDefault(__webpack_require__(122));
function default_1(action, context) {
    if (action !== prompt_service_1.PromptAction.GENERATE) {
        return (0, getHelpPrompt_1.default)(action, context);
    }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const prompt_service_1 = __webpack_require__(8);
const help_1 = __importDefault(__webpack_require__(121));
function default_1(action, context) {
    if (action !== prompt_service_1.PromptAction.HELP) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CONFIG_API_MODEL_NAME = exports.CONFIG_API_KEY_NAME = exports.CONFIG_APP_NAME = void 0;
exports.CONFIG_APP_NAME = "ai-generate-code";
exports.CONFIG_API_KEY_NAME = "apiKey";
exports.CONFIG_API_MODEL_NAME = "model";
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const openai_1 = __importDefault(__webpack_require__(14));
exports["default"] = async ({ apiKey, settings }) => {
    ...
    const completion = async (prompt) => {
        ...
        try {
            const gptResponse = await openai.chat.completions.create(chatCompletionParams);
...
const Errors = __importStar(__webpack_require__(77));
const Uploads = __importStar(__webpack_require__(78));
const Pagination = __importStar(__webpack_require__(79));
...
const version_1 = __webpack_require__(16);
const streaming_1 = __webpack_require__(17);
const error_1 = __webpack_require__(77);
const index_1 = __webpack_require__(18);
const uploads_1 = __webpack_require__(78);
var uploads_2 = __webpack_require__(78);
...
const index_1 = __webpack_require__(18);
const error_1 = __webpack_require__(77);
const error_2 = __webpack_require__(77);
class Stream {
 ...
 */
const shims = __webpack_require__(19);
const auto = __webpack_require__(20);
 ...
 * Disclaimer: modules in _shims aren't intended to be imported by SDK users.
 */
const nf = __importStar(__webpack_require__(22));
const fd = __importStar(__webpack_require__(37));
const agentkeepalive_1 = __importDefault(__webpack_require__(48));
const abort_controller_1 = __webpack_require__(54);
const node_fs_1 = __webpack_require__(56);
const form_data_encoder_1 = __webpack_require__(57);
const node_stream_1 = __webpack_require__(68);
const MultipartBody_1 = __webpack_require__(69);
// @ts-ignore (this package does not have proper export maps for this export)
const ponyfill_es2018_js_1 = __webpack_require__(70);
let fileFromPathWarned = false;
async function fileFromPath(path, ...args) {
    // this import fails in environments that don't handle export maps correctly, like old versions of Jest
    const { fileFromPath: _fileFromPath } = await Promise.resolve().then(() => __importStar(__webpack_require__(71)));
...
/* harmony export */ });
/* harmony import */ var stream__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(23);
...
const File_1 = __webpack_require__(40);
const isFile_1 = __webpack_require__(45);
const isBlob_1 = __webpack_require__(46);
const isFunction_1 = __webpack_require__(43);
const deprecateConstructorEntries_1 = __webpack_require__(47);
class FormData {
    constructor(entries) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.File = void 0;
const Blob_1 = __webpack_require__(41);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Blob = void 0;
const web_streams_polyfill_1 = __webpack_require__(42);
const isFunction_1 = __webpack_require__(43);
const blobHelpers_1 = __webpack_require__(44);
class Blob {
...
module.exports.HttpsAgent = __webpack_require__(53);
module.exports.constants = __webpack_require__(52);
...
const OriginalAgent = (__webpack_require__(24).Agent);
const ms = __webpack_require__(50);
...
const OriginalHttpsAgent = (__webpack_require__(35).Agent);
const HttpAgent = __webpack_require__(49);
const {
  INIT_SOCKET,
...
var eventTargetShim = __webpack_require__(55);
...
const node_domexception_1 = __importDefault(__webpack_require__(74));
const File_1 = __webpack_require__(40);
...
if (!globalThis.DOMException) {
  try {
    const { MessageChannel } = __webpack_require__(75),
...
var audio_1 = __webpack_require__(86);
Object.defineProperty(exports, "Audio", ({ enumerable: true, get: function () { return audio_1.Audio; } }));
var batches_1 = __webpack_require__(90);
...
var beta_1 = __webpack_require__(91);
Object.defineProperty(exports, "Beta", ({ enumerable: true, get: function () { return beta_1.Beta; } }));
var completions_1 = __webpack_require__(111);
Object.defineProperty(exports, "Completions", ({ enumerable: true, get: function () { return completions_1.Completions; } }));
var embeddings_1 = __webpack_require__(112);
Object.defineProperty(exports, "Embeddings", ({ enumerable: true, get: function () { return embeddings_1.Embeddings; } }));
var files_1 = __webpack_require__(113);
...
Object.defineProperty(exports, "Completions", ({ enumerable: true, get: function () { return completions_1.Completions; } }));
var chat_1 = __webpack_require__(84);
...
const resource_1 = __webpack_require__(83);
...
exports.Chat = void 0;
const resource_1 = __webpack_require__(83);
const CompletionsAPI = __importStar(__webpack_require__(82));
...
const resource_1 = __webpack_require__(83);
const SpeechAPI = __importStar(__webpack_require__(87));
const TranscriptionsAPI = __importStar(__webpack_require__(88));
const TranslationsAPI = __importStar(__webpack_require__(89));
...
const resource_1 = __webpack_require__(83);
const core_1 = __webpack_require__(15);
const BatchesAPI = __importStar(__webpack_require__(90));
...
exports.Beta = void 0;
const resource_1 = __webpack_require__(83);
const AssistantsAPI = __importStar(__webpack_require__(92));
const ChatAPI = __importStar(__webpack_require__(93));
const ThreadsAPI = __importStar(__webpack_require__(101));
const VectorStoresAPI = __importStar(__webpack_require__(107));
...
const resource_1 = __webpack_require__(83);
const core_1 = __webpack_require__(15);
const AssistantStream_1 = __webpack_require__(102);
const MessagesAPI = __importStar(__webpack_require__(104));
const RunsAPI = __importStar(__webpack_require__(105));
...
const Core = __importStar(__webpack_require__(15));
const AbstractAssistantStreamRunner_1 = __webpack_require__(103);
const streaming_1 = __webpack_require__(17);
const error_1 = __webpack_require__(77);
...
const core_1 = __webpack_require__(15);
const AssistantStream_1 = __webpack_require__(102);
const core_2 = __webpack_require__(15);
const RunsAPI = __importStar(__webpack_require__(105));
const StepsAPI = __importStar(__webpack_require__(106));
const pagination_1 = __webpack_require__(79);
...
const core_1 = __webpack_require__(15);
const VectorStoresAPI = __importStar(__webpack_require__(107));
const FileBatchesAPI = __importStar(__webpack_require__(108));
...
const core_2 = __webpack_require__(15);
const error_1 = __webpack_require__(77);
const FilesAPI = __importStar(__webpack_require__(113));
const core_3 = __webpack_require__(15);
const pagination_1 = __webpack_require__(79);
class Files extends resource_1.APIResource {
    /**
...
const resource_1 = __webpack_require__(83);
const JobsAPI = __importStar(__webpack_require__(115));
...
const core_1 = __webpack_require__(15);
const JobsAPI = __importStar(__webpack_require__(115));
const CheckpointsAPI = __importStar(__webpack_require__(116));
const pagination_1 = __webpack_require__(79);
...
const resource_1 = __webpack_require__(83);
const ModelsAPI = __importStar(__webpack_require__(118));
const pagination_1 = __webpack_require__(79);
...
const constants_1 = __webpack_require__(12);
function default_1() {
    const defaultConfig = vscode.workspace.getConfiguration(constants_1.CONFIG_APP_NAME);
    const apiKey = defaultConfig.get(constants_1.CONFIG_API_KEY_NAME) ?? "";
    const model = defaultConfig.get(constants_1.CONFIG_API_MODEL_NAME) ?? "gpt-3.5-turbo";
    return {
        apiKey,
        model,
    };
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports["default"] = `I want you to act as a senior software engineer. 
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports["default"] = `I want you act as a specialist software engineer. I will give you a single story task and the language you should code. You will then create the code files for me that represents how to build this task. You should reply only the code, avoiding comments, explanations, code block, or anything else. It's important that you create the codes, following the clean code practices,  following SOLID and implementing language patterns. You must reply the desired architecture for this language.

WARNING: DO NOT REPLY COMMENTS, JUST CODE.
