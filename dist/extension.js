...
const constants_1 = __webpack_require__(119);
function activate(context) {
    const apikey = vscode.workspace.getConfiguration().get(constants_1.CONFIG_API_KEY_NAME);
    if (!apikey || apikey === "") {
...
function default_1(context) {
    ...
    aiCode.iconPath = vscode.Uri.joinPath(context.extensionUri, "assets", "icons", "plugin-chat-profile.jpg");
}
...
const handler = async (request, context, stream, token, extContext) => {
    const strategyResponse = await (0, strategy_1.default)(request, extContext);
...
const ai_client_service_1 = __importDefault(__webpack_require__(7));
const prompt_service_1 = __importStar(__webpack_require__(114));
const constants_1 = __webpack_require__(119);
async function default_1(request, extensionContext) {
    ...
    const model = vscode.workspace.getConfiguration().get(constants_1.CONFIG_API_MODEL_NAME) ||
        "gpt-3.5-turbo";
...
const vscode = __importStar(__webpack_require__(1));
const __1 = __webpack_require__(3);
const explain_plugin_action_1 = __importDefault(__webpack_require__(118));
const prompt_service_1 = __importStar(__webpack_require__(114));
const ai_client_service_1 = __importDefault(__webpack_require__(7));
const constants_1 = __webpack_require__(119);
async function default_1(request, extensionContext) {
...
const Uploads = __importStar(__webpack_require__(72));
...
const uploads_1 = __webpack_require__(72);
var uploads_2 = __webpack_require__(72);
...
const ponyfill_es2018_js_1 = __webpack_require__(64);
...
var audio_1 = __webpack_require__(80);
Object.defineProperty(exports, "Audio", ({ enumerable: true, get: function () { return audio_1.Audio; } }));
var batches_1 = __webpack_require__(84);
...
var beta_1 = __webpack_require__(85);
...
var completions_1 = __webpack_require__(76);
Object.defineProperty(exports, "Completions", ({ enumerable: true, get: function () { return completions_1.Completions; } }));
...
const resource_1 = __webpack_require__(77);
const SpeechAPI = __importStar(__webpack_require__(81));
const TranscriptionsAPI = __importStar(__webpack_require__(82));
const TranslationsAPI = __importStar(__webpack_require__(83));
...
const resource_1 = __webpack_require__(77);
const core_1 = __webpack_require__(9);
const BatchesAPI = __importStar(__webpack_require__(84));
...
exports.Beta = void 0;
const resource_1 = __webpack_require__(77);
const AssistantsAPI = __importStar(__webpack_require__(86));
const ChatAPI = __importStar(__webpack_require__(87));
const ThreadsAPI = __importStar(__webpack_require__(95));
...
exports.Chat = void 0;
const resource_1 = __webpack_require__(77);
const CompletionsAPI = __importStar(__webpack_require__(88));
class Chat extends resource_1.APIResource {
    constructor() {
        super(...arguments);
        this.completions = new CompletionsAPI.Completions(this._client);
...
const resource_1 = __webpack_require__(77);
const ChatCompletionRunner_1 = __webpack_require__(89);
var ChatCompletionRunner_2 = __webpack_require__(89);
...
var RunnableFunction_1 = __webpack_require__(91);
...
const AbstractChatCompletionRunner_1 = __webpack_require__(90);
const chatCompletionUtils_1 = __webpack_require__(92);
...
const error_1 = __webpack_require__(71);
const RunnableFunction_1 = __webpack_require__(91);
const chatCompletionUtils_1 = __webpack_require__(92);
...
const resource_1 = __webpack_require__(77);
const core_1 = __webpack_require__(9);
const AssistantStream_1 = __webpack_require__(96);
...
const Core = __importStar(__webpack_require__(9));
const AbstractAssistantStreamRunner_1 = __webpack_require__(97);
const streaming_1 = __webpack_require__(11);
const error_1 = __webpack_require__(71);
...
const core_3 = __webpack_require__(9);
const pagination_1 = __webpack_require__(73);
class Files extends resource_1.APIResource {
    /**
...
const actionStrategy_1 = __importDefault(__webpack_require__(115));
var PromptAction;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const getGeneratePrompt_1 = __importDefault(__webpack_require__(116));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const vscode = __importStar(__webpack_require__(1));
const prompt_service_1 = __webpack_require__(114);
const getHelpPrompt_1 = __importDefault(__webpack_require__(117));
function default_1(action, context) {
    ...
    const generatePromptFile = vscode.Uri.joinPath(context.extensionUri, "core", "prompt", "generate.txt");
    const streamReader = vscode.workspace.fs.readFile(generatePromptFile);
    const prompt = streamReader.then((buffer) => new TextDecoder().decode(buffer));
    return prompt;
}
exports["default"] = default_1;
...
function default_1(action, context) {
    ...
    const helpPromptFile = vscode.Uri.joinPath(context.extensionUri, "core", "prompt", "help.txt");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CONFIG_API_MODEL_NAME = exports.CONFIG_API_KEY_NAME = void 0;
exports.CONFIG_API_KEY_NAME = "ai-generate-code.apiKey";
exports.CONFIG_API_MODEL_NAME = "ai-generate-code.model";
