...
declare module 'vscode' {
	 ...
	 */
	export type ChatRequestHandler = (request: ChatRequest, context: ChatContext, response: ChatResponseStream, token: CancellationToken, extContext: ExtensionContext) => ProviderResult<ChatResult | void>;
